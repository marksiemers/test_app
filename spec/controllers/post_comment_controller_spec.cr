...
def post_comment_hash
  {"user_id" => "1", "name" => "Fake", "body" => "Fake", "age" => "1", "published" => "true", "post_id" => "1"}
end

def post_comment_params
  params = [] of String
  params << "user_id=#{post_comment_hash["user_id"]}"
  params << "name=#{post_comment_hash["name"]}"
  params << "body=#{post_comment_hash["body"]}"
  params << "age=#{post_comment_hash["age"]}"
  params << "published=#{post_comment_hash["published"]}"
